 ...
 */
public class Camera2RecordActivity extends AppCompatActivity implements TextureView.SurfaceTextureListener, View.OnClickListener {
    //views
    ...
    private void initViews() {
        ...
        tvBalanceTime = (TextView) findViewById(R.id.tv_balanceTime);
        ivTakePhoto = (ImageView) findViewById(R.id.iv_takePhoto);
        ivSwitchCamera = (ImageView) findViewById(R.id.iv_switchCamera);
        ivLightOn = (ImageView) findViewById(R.id.iv_lightOn);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.iv_switchCamera) {
            ...
            //开始或结束录像
            if (!isRecording) {
                ivTakePhoto.setBackgroundResource(R.drawable.ic_capture_btn_stop);
...
//                profile.videoBitRate = mPreviewSize.getWidth() * mPreviewSize.getHeight();
                ...
                mMediaRecorder.setVideoEncodingBitRate(921600);
